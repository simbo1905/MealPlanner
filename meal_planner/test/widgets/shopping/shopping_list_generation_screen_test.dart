...
void main() {
  ...
  group('ShoppingListGenerationScreen Widget Tests', () {
    ...
    testWidgets('generates shopping list on button tap', (tester) async {
      // Arrange
      final recipe = Recipe(
        id: 'recipe-1',
        title: 'Pasta',
    ...
    testWidgets('aggregates items from multiple recipes', (tester) async {
      // Arrange
    ...
    testWidgets('groups items by section in preview', (tester) async {
      // Arrange
      final recipe = Recipe(
        id: 'recipe-1',
        title: 'Recipe',
